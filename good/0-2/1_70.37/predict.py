...
def build_siamese_model():
    # กลับมาใช้ B3 แบบ pooling='avg' ตามที่รันล่าสุด
    ...
    # ต้องมี BatchNormalization เหมือนตอนเทรน
    bn_layer = layers.BatchNormalization()
    feat_1 = bn_layer(feat_1)
    feat_2 = bn_layer(feat_2)
    ...
    # เปลี่ยนขนาด Dense ให้เป็น 256 และ 64 ตามที่เทรนล่าสุด
